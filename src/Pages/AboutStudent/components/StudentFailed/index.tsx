...
export const StudentFailed = ({ dataStudent }: StudentsDataProps) => {
  ...
  const handlePassedTheTest = (data: updateStudentsFormInputs) => {
    ...
    if (data.payment_of_duda === 'Sim') {
      payment_of_duda = 'Pago'
    } else {
      payment_of_duda = 'Pendente'
    }

    console.log(payment_of_duda)
