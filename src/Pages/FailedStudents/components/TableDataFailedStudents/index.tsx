...
export const TableFailedStudents = () => {
  const { listFailedStudents, listSelectedCar, searchListStudent } =
    useDataStudent()
  ...
  const [searchListSelected, setSearchListSelected] =
    useState<DataStudentsProps[]>(listFailedStudents)
  ...
  useEffect(() => {
    if (searchListStudent) {
      const searchListStudents = listFailedStudents.filter((list) => {
        return (
      ...
      setSearchListSelected(listFailedStudents)
    }
  }, [listFailedStudents, searchListStudent])
