...
export const TableApprovedStudents = () => {
  const { listApprovedStudents, listSelectedCar, searchListStudent } =
    useDataStudent()
  ...
  useEffect(() => {
    if (searchListStudent) {
      const searchListStudents = listApprovedStudents.filter((list) => {
        return (
      ...
      setSearchListSelected(listApprovedStudents)
    }
  }, [listApprovedStudents, searchListStudent])
