...
export const TableStudents = () => {
  const { listAuthorizedStudents, listSelectedCar, searchListStudent } =
    useDataStudent()
  ...
  useEffect(() => {
    if (searchListStudent) {
      const searchListStudents = listAuthorizedStudents.filter((list) => {
        return (
      ...
      setSearchListSelected(listAuthorizedStudents)
    }
  }, [listAuthorizedStudents, searchListStudent])
